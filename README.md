...
[![Version](https://img.shields.io/badge/version-2.3.01-brightgreen.svg)](https://github.com/poouo/Forwardx/releases)
...
| `FORWARDX_TARGET_VERSION` | 空 | 安装或升级到指定版本，例如 `v2.3.01` |
